...
def xdet_model_fn(features, labels, mode, params):
    ...
    with tf.variable_scope(params['model_scope'], default_name=None, values=[features], reuse=tf.AUTO_REUSE):
        backbone = xdet_body_v5.xdet_resnet_v5(params['resnet_size'], params['data_format'])
        backbone_outputs = backbone(inputs=features, is_training=(mode == tf.estimator.ModeKeys.TRAIN))

        cls_pred, location_pred = xdet_body_v5.xdet_head(backbone_outputs, params['num_classes'], all_num_anchors_depth, (mode == tf.estimator.ModeKeys.TRAIN), data_format=params['data_format'])
...
# AP for train = 0.8683
# AP for bus = 0.8134
# AP for bicycle = 0.7903
# AP for boat = 0.6364
# AP for sheep = 0.7435
# AP for tvmonitor = 0.6660
# AP for cat = 0.8808
# AP for pottedplant = 0.4451
# AP for chair = 0.5347
# AP for aeroplane = 0.7665
# AP for person = 0.7477
# AP for car = 0.7953
# AP for horse = 0.8477
# AP for diningtable = 0.7632
# AP for bottle = 0.3573
# AP for sofa = 0.8165
# AP for bird = 0.7394
# AP for cow = 0.7616
# AP for motorbike = 0.7994
# AP for dog = 0.8475
# Mean AP = 0.7310
