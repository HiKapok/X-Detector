...
image_size = {
 ...
 # keras: inbound_nodes -> _inbound_nodes
 # keras2ir.py -n xception
 # -m mmdnn.conversion._script.IRToCode -f tensorflow --IRModelPath xception.pb --IRWeightPath xception.npy --dstModelPath tf_xception.py
 # -m mmdnn.conversion.examples.tensorflow.imagenet_test -s tf -p xception -n tf_xception -w xception.npy
 # test xception.npy, and compare with keras' output
 # -m mmdnn.conversion.examples.tensorflow.imagenet_test -n tf_xception.py -w xception.npy --dump tf_xception.ckpt
